...
<body>
	...
	<p> 
		JSP
			- html형식으로 자바코드를 기술할 수 있는 자바언어. 서블릿에서 응답화면을 구현했을시 발생하는 복잡성을 줄이기 위해 탄생
			- servlet은 백엔드 비지니스 로직에 집중하고, jsp는 응답화면(view) 구현에 집중할 수 있도록 역할을 분리
	</p>
	...
	<ol>
		<li>
			page 지시어 : 현재 jsp페이지를 처리하는데 필요한 각종 속성을 기술하는 지시어
			<ul>
				<li>language : 현재 jsp에서 사용할 언어유형</li>
				<li>contentType : 웹 브라우저가 받아 볼 페이지의 형식 및 인코딩 타입</li>
				<li>pageencodeing : jsp파일에 기록된 자바코드의 인코딩 방식</li>
		...
		<li>
			include 지시어 : jsp파일에 다른 jsp파일을 포함시킬 때 사용 <br>
	...
	<p>
		기존에 사용했던 표현식, 출력식을 jsp에서 간결한 방식으로 사용할 수 있도록 지원하는 언어
	</p>
	<h3>EL 기본 뭄법</h3>
	<a href="/jsp/el/el.do">01_EL</a>
	
	<h3>EL의 연산자</h3>
	<a href="/jsp/el/oper.do">EL의 연산자</a>
	
	<hr>
	
	<h1>JSP Action Tag</h1>
	<p>
		XML기술을 이용하여 JSP문법을 확장시켜 새로운 기술을 제공하는 태그
		<br>
		1. 표준 액션 태그 <br>
			- 별도의 설치없이 JSP에서 바로 사용가능한 태그 <br>
		2. 커스텀 액션 태그 <br>
			- 별도의 추가설치가 필요한 태그, 라이브러리 설치 후 jsp taglib지시어를 추가해야함. <br>
			- 종류별로 다양한 기능 제공 <br>
	</p>
	<h3>1. 표준 액션 태그</h3>
